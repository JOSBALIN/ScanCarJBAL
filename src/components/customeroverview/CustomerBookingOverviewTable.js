...
const columns = [
  ...
  { field: "name",  headerName: "Full Name", minWidth: 140, flex: 0.6, hide:true  },
  { field: "phoneNum",  headerName: "Phone", minWidth: 110, sortable:false, hide:true},
...
export default function GridTable(props) {
  ...
  React.useEffect(async() => { 
    const allBookings = await getCustomerBookings(props.licenseID);
